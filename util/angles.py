...
angles are normalized i.e., [0, 360.0) or [0, 2Ï) or [0, 24.0). The
other method normalizes angles in the manner that latitudinal angles
are normalized i.e., [-90, 90] or [-Ï/2, Ï/2].
...
def r2r(r):
    """Normalize angle in radians to [0, 2Ï)."""
...
def sep(a1, b1, a2, b2):
    ...
    This will be an angle between [0, Ï] radians.
...
def bear(a1, b1, a2, b2):
    ...
    pole. It is between [0 and Ï] if the second point is in the
    eastern hemisphere w.r.t the first, and between (0, -Ï) if
...
class AlphaAngle(Angle):
    ...
    def _setnorm(self, val):
        ...
        self._raw = r2r(val)  # [0, 2Ï) i.e., h = [0, 24).
